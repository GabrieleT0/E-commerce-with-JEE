...
<div class="container-sm h-100 text-white" id="box">
	...
	<div class="text-center">Non sei iscritto? <a href="<%=response.encodeRedirectURL("Registration.jsp")%>"> Registrati</a></div>
</div>
<script>
